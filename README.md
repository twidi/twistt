...
TWISTT_OSD_SPECTRUM_HEIGHT=28  # Spectrum analyzer height as % of window height, 0-100 (default: 28)
TWISTT_OSD_OPACITY=0.9  # Global overlay opacity, 0.0-1.0 (default: 0.9)
...
| `--osd-spectrum-height`                        | `TWISTT_OSD_SPECTRUM_HEIGHT`                       | 28                            | OSD spectrum analyzer height as % of window height (0-100)                                                                                                                                                              |
| `--osd-opacity`                                | `TWISTT_OSD_OPACITY`                               | 0.9                           | OSD global overlay opacity (0.0-1.0)                                                                                                                                                                                    |
...
- Spectrum height: `--osd-spectrum-height 28` (percentage 0-100 of window height, default 28)
- Opacity: `--osd-opacity 0.9` (0.0-1.0, default 0.9). Controls the global transparency of the entire overlay
